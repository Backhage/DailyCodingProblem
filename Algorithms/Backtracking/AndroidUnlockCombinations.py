...
def unlock_combinations(n):
    ...
    # The number of paths starting with 1 are the same for 3, 7, and 9.
    # Similarly, the number of paths starting with 2 are the same for 4, 6, and 8.
    # This means we can multiply by 4 instead of calculating each number separately.
    return (
        4 * num_paths(1, jumps, set([1]), n)
